  ...
  function getGlobalStats() {
    ...
    $.ajax({
      ...
      .then(function (response) {
        $("#countConfirmed").text(
          numberWithCommas(response.Global.TotalConfirmed)
        );
        $("#countRecovered").text(
          numberWithCommas(response.Global.TotalRecovered)
        );
  ...
  $.get("/api/user_data").then(function (data) {
    if (data.email) {
      ...
      if (data.subscription) {
        // Check it
        $(".member-name")
          .append(`<div class="b-checkbox is-success is-circular">
      ...
      $("#subscription-navbar").click(function () {
        ...
        $("#subscription-message").text(
          $("#subscription-message").text() == "Subscribe to Newsletter"
            ? "Subscribed to Newsletter"
            : "Subscribe to Newsletter"
        );
      });
